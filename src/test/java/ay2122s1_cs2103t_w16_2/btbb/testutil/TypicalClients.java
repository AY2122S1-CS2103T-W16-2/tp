...
import static ay2122s1_cs2103t_w16_2.btbb.logic.commands.CommandTestUtil.VALID_MEMBERSHIP_AMY;
...
public class TypicalClients {
    public static final Client ALICE = new ClientBuilder().withName("Alice Pauline")
            ...
            .withMembership("01-01-2021 01-04-2021").build();
    public static final Client BENSON = new ClientBuilder().withName("Benson Meier")
            .withAddress("311, Clementi Ave 2, #02-25").withEmail("johnd@example.com")
            .withMembership("01-06-2021 01-01-2022").withPhone("98765432").build();
    public static final Client CARL = new ClientBuilder().withName("Carl Kurz")
            .withPhone("95352563").withEmail("heinz@example.com")
            .withAddress("wall street").withMembership("01-01-2021 01-07-2021").build();
